...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *localStr = [NSHomeDirectory()stringByAppendingPathComponent:@"Documents"];
                          
    db=[PFDBManager creatDataBaseWithFilePath:[localStr stringByAppendingString:@"/image.db"]];
